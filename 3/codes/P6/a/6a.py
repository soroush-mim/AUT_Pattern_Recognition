...
#changing type of species column to category
...
for i in range(400):
    ...
    a = a - .000003 * (x_train_a.T @ (x_train_a @ a - b))
...
plt.legend()
plt.savefig('decision boundary gradian')
plt.clf()
...
plt.legend()
plt.savefig('decision boundary newton')
